...
namespace AsyncGenerator.Extensions
{
	...
	{
		private static readonly SyntaxTrivia[] AutoGeneratedTrivia =
		{
			Comment("//------------------------------------------------------------------------------"),
	...
	public static bool IsPrecondition(this StatementSyntax statement)
		...
		internal static SyntaxToken AddAutoGeneratedTrivia(this SyntaxToken token)
		{
			return token.WithLeadingTrivia(AutoGeneratedTrivia.Union(token.LeadingTrivia));
		}
