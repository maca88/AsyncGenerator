...
namespace AsyncGenerator.Core
{
	...
	public enum MethodCancellationToken
	{
		...
		/// This option shall be combined with <see cref="Required"/> option.
		/// </summary>
		ForwardNone = 4,
		/// <summary>
		/// The same as <see cref="ForwardNone"/> with the addition that the sealed keyword will be added for overrides and virtual keyword removed from the virtual methods.
		/// This option shall be combined with <see cref="Required"/> option.
		/// </summary>
		SealedForwardNone = 8
	}
